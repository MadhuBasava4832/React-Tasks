...
export const SignupPage = () => {
    ...
    //     e.preventDefault();
    //     count += 1;
    //     const zx = document.querySelector(".parent");
    //     if(count %2==0){
    //         zx.style.transform = 'rotateY(180deg)';
    //     }else{
    //         zx.style.transform = 'rotateY(360deg)';
    //     }
    // }
    ...
    const submitfun1 = (e) => {
        e.preventDefault();
        console.log(use);
        var us = JSON.parse(localStorage.getItem(use.email));        
